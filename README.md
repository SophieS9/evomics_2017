...
Install notes for additional software added for Harvard 2016 can be found in: [install_notes.md](https://github.com/SophieS9/evomics_2017/blob/master/install_notes.md).
